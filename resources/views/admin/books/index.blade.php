<x-admin-dashboard>
    ...
    <div class="flex justify-end">
        <a href="{{ route('admin.books.create') }}" class="text-white bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700
        hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-indigo-300 dark:focus:ring-indigo-800
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @forelse($books as $book)
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.books.show', $book) }}" class="font-medium text-cyan-600 dark:text-cyan-500 hover:underline me-2">Show</a>
                        <a href="{{ route('admin.books.edit', $book) }}" class="font-medium text-violet-600 dark:text-violet-500 hover:underline me-2">Edit</a>
                    </td>
                </tr>
            @empty
                <tr>
