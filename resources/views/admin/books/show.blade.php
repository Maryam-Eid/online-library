    ...
    <div class="max-w-lg mx-auto mt-10 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            ...
            <p class="text-gray-700 dark:text-gray-300 mb-4 flex items-center">
                ...
                Copies: {{ $book->copies }} | Borrowed: {{ $book->borrowedBy->count() }}
            </p>

            <div class="flex gap-2 mt-4">
                <a href="{{ route('admin.books.edit', $book->id) }}"
                   class="flex-1 text-center py-2.5 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all">
                    Edit
                </a>

                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                        class="flex-1 text-center py-2.5 bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-white dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
                        type="button">
                    Delete
                </button>
            </div>
